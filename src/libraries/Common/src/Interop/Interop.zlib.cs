...
internal static partial class Interop
{
    internal static partial class zlib
    {
        ...
        internal static partial ZLibNative.ErrorCode DeflateInit2_(
        ...
        internal static partial ZLibNative.ErrorCode Deflate(ref ZLibNative.ZStream stream, ZLibNative.FlushCode flush);

        [GeneratedDllImport(Libraries.CompressionNative, EntryPoint = "CompressionNative_DeflateReset")]
        internal static partial ZLibNative.ErrorCode DeflateReset(ref ZLibNative.ZStream stream);

        [GeneratedDllImport(Libraries.CompressionNative, EntryPoint = "CompressionNative_DeflateEnd")]
        internal static partial ZLibNative.ErrorCode DeflateEnd(ref ZLibNative.ZStream stream);

        [GeneratedDllImport(Libraries.CompressionNative, EntryPoint = "CompressionNative_InflateInit2_")]
        internal static partial ZLibNative.ErrorCode InflateInit2_(ref ZLibNative.ZStream stream, int windowBits);

        [GeneratedDllImport(Libraries.CompressionNative, EntryPoint = "CompressionNative_Inflate")]
        internal static partial ZLibNative.ErrorCode Inflate(ref ZLibNative.ZStream stream, ZLibNative.FlushCode flush);

        [GeneratedDllImport(Libraries.CompressionNative, EntryPoint = "CompressionNative_InflateReset")]
        internal static partial ZLibNative.ErrorCode InflateReset(ref ZLibNative.ZStream stream);

        [GeneratedDllImport(Libraries.CompressionNative, EntryPoint = "CompressionNative_InflateEnd")]
        internal static partial ZLibNative.ErrorCode InflateEnd(ref ZLibNative.ZStream stream);
