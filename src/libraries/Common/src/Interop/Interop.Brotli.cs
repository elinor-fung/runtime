...
internal static partial class Interop
{
    internal static partial class Brotli
    {
        ...
        [GeneratedDllImport(Libraries.CompressionNative)]
        internal static unsafe partial bool BrotliDecoderDecompress(nuint availableInput, byte* inBytes, ref nuint availableOutput, byte* outBytes);
        ...
        [GeneratedDllImport(Libraries.CompressionNative)]
        internal static unsafe partial bool BrotliEncoderCompress(int quality, int window, int v, nuint availableInput, byte* inBytes, ref nuint availableOutput, byte* outBytes);
    }
}
